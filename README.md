<h1 align="center">Hi 👋, I'm Bhagat Raj</h1>
<h3 align="center">☁️ Cloud & Infrastructure Engineer | DevOps | Azure | Kubernetes | Terraform</h3>
...
- ✈️ Senior Cloud & Infrastructure Engineer @ **Air Canada**
- 🌍 Based in **Toronto, Canada**
- ⚙️ 4+ years in **Cloud, DevOps & SRE**
- ☁️ Azure | AWS | Kubernetes | Terraform | CI/CD
...
```diff
+ Most of my work is in enterprise/private repositories
+ Focused on production-grade cloud infrastructure
+ Contributions reflect real-world DevOps work, not just public commits
